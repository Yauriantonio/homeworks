...
const CssMinimizer = require('css-minimizer-webpack-plugin'); //  Será de optimization.
const Terser       = require('terser-webpack-plugin'); 
// require: se útiliza para las importaciones en // NODE.

module.exports = { // Es un módulo que se va a exportar.
    mode: "production", // Es un modulo de desarrollo o de producción que quiere decir que queremos minimizar el código.
 // Y ya no nos marca el error, ya encuentra los archivos y el main ya no se encuentra minimizado u ofuscado, esta en modo de desarrollo.
    output:{ // Borra toda la carpeta dist y la vuelve a crear.
        ...
        filename:'main.[contenthash].js' // Agregamos un hash al - main -
    },
...
module: {
    rules: [
        ...
        { // Estas lineas de código van a permitir trabajar con Babel, se encuentra en la documentación oficial.
            test: /\.m?js$/,
...
optimization: { // Está optimización se útiliza para que el main de css este ofuscado y más ligero.
    minimize: true,
    minimizer: [
        new CssMinimizer(),
        new Terser(),
...
// Permite minimizar el código de css de la carpeta dist

// npm i -D css-minimizer-webpack-plugin terser-webpack-plugin

// Se instala el terser y el minimizer en package.json

// INSTALACIÓN Y CONFIGURACIÓN DE BABEL

// Permite la compatibilidad con versiones anteriores de  JS de ES6.

// https://babeljs.io/

// - npm install --save-dev babel-loader @babel/core -

// Es una dependencia de desarrollo al igual que las demás en package.json
// Se instala el - babel-loader - que nos va a ayudar a cargar los archivos.
// @babel/core - Es la libreria que nos permite realizar las traducciones respectivas.

// Nos va a permitir trabajar con las configuraciones de Babel, por si queremos que trabaje de una manera especifica.
// - npm install @babel/preset-env --save-dev -
// Estas configuraciones no son necesarias, pero nos pueden servir de mucho.
// Creamos el archivo - babel.config.json - en la carpeta raíz.
// Está configuración sólo la hacemos en el webpack en modo de producción.

// GIT Y GIT HUB

// git checkout --. - Reconstuye los archivos.

// npm install - Este comando recupera toda la informacion dentro de nuesto package.json, por eso no
// No se da seguimiento a la carpeta node_modules ya que se puede recontruir con el comando anterior.
